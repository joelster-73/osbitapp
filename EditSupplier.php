...
<head>
	...
	<title>Suppliers | Edit</title> <!--Appears in the tab-->
...
<?php
	...
	if (isset($_GET['formSubmitted'])) {  //checks for the form to be submitted
		...
		if ($exists) { //if the record has been found
			echo "<script type='text/javascript'>window.location.href='EditSupplierForm.php?val='+".$_GET['supID'].";</script>"; //redirects user to form to edit if supplier found
		} else {
  ...
  <div id="navigation"></div>
	...
	<div class="content">
		...
		<form id="miniForm" method="get">
			<h3>Find a Supplier to Edit</h3> <br>
			...
			<input type="submit" value="Find Supplier"><!--To retrieve data to be editted-->
		</form>
