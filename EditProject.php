...
<head>
	...
	<title>Projects | Edit</title> <!--Appears in the tab-->
...
<?php
	...
	if (isset($_GET['formSubmitted'])) {  //checks for the form to be submitted
		...
		if ($exists) { //if the record has been found
			echo "<script type='text/javascript'>window.location.href='EditProjectForm.php?val='+".$_GET['projectID'].";</script>"; //redirects user to form to edit if supplier found
		} else {
			echo "<script type='text/javascript'>window.alert('This Project was not found'); window.location.href='EditProject.php';</script>"; //informed supplier not found if appropiate
		}
	}
?>
  ...
  <div id="navigation"></div>
	...
	<div class="content">
		...
		<form id="miniForm" method="get">
			<h3>Find a Project to Edit</h3> <br> <!--Title of the form-->
			...
			<input type="submit" value="Find Project"><!--To retrieve data to be editted-->
		</form>
